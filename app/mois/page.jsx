...
export default function CeMoisPage() {
  ...
  return <div className="space-y-5">
    ...
    <div className="grid grid-cols-2 gap-2"><Link href="/plan" className="rounded-v3-m bg-marque-pale p-3.5 text-sm font-semibold text-marque-texte">Préparer mon plan ›</Link><Link href="/transactions" className="rounded-v3-m bg-ui-surface-raised p-3.5 text-sm font-semibold">Voir mes opérations ›</Link><Link href="/cloture" className="col-span-2 rounded-v3-m bg-ui-surface-raised p-3.5 text-sm font-semibold">Clôturer le mois ›</Link></div>
  </div>;
}
