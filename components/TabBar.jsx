        ...
        {ONGLETS.map((o) =>
          o.href === "AJOUT" ? (
            <button
              ...
              className="mx-auto -mt-2.5 flex h-12 w-12 items-center justify-center rounded-full text-xl font-light text-white shadow-bouton ring-4 ring-fond active:scale-95 transition-transform"
